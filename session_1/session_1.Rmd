...
```{r, echo = F, results="asis", fig.width=10, fig.height= 6, cache = T}
gg_p2 <- ggpairs(all_3[, c(17:22)], 
               lower = list(continuous = my_fun_lo),
               diag = list(continuous = my_fun_mid)) + 
          theme_classic() + ggtitle("Itembatterie: Islamophobie")
